...
fn complete_catalog_has_a_stable_aggregate_pixel_fingerprint() -> Result<(), hashavatar::AvatarError>
{
    ...
    assert_eq!(
        aggregate.finalize(),
        [
            106, 17, 116, 228, 14, 142, 65, 80, 97, 109, 203, 42, 174, 174, 88, 59, 77, 32, 170, 3,
            143, 32, 152, 195, 15, 23, 222, 176, 191, 134, 110, 15, 222, 61, 200, 43, 170, 32, 190,
            198, 191, 93, 7, 13, 91, 24, 60, 33, 139, 177, 103, 55, 254, 139, 253, 64, 144, 165,
            249, 59, 83, 112, 235, 6,
        ]
    );
    Ok(())

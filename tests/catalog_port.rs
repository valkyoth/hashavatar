...
fn complete_catalog_has_a_stable_aggregate_pixel_fingerprint() -> Result<(), hashavatar::AvatarError>
{
    ...
    assert_eq!(
        aggregate,
        [
            87, 233, 61, 246, 215, 28, 110, 179, 19, 148, 221, 76, 13, 55, 141, 145, 45, 135, 162,
            20, 166, 184, 56, 223, 60, 79, 78, 66, 172, 128, 148, 157, 255, 162, 188, 165, 190, 92,
            80, 7, 9, 173, 10, 27, 239, 109, 72, 3, 76, 51, 55, 192, 165, 177, 123, 19, 98, 5, 152,
            252, 51, 163, 46, 148,
        ]
    );
    Ok(())

...
| --- | --- | --- | --- |
| `hashavatar-core` | `0.1.0-alpha.2` | Source-only; never published for this alpha | Portable canonical renderer core |
| `hashavatar` | `2.0.0-alpha.2` | Source-only; crates.io remains `1.3.0` | Recommended facade |
